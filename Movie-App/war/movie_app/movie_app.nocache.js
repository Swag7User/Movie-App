...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "movie_app" because\n';
  ...
  $wnd.__gwt_activeModules['movie_app'] = {
 ...
 * "/movie_app.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['movie_app'].superdevmode = true;

  var expectedSuffix = '/movie_app.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + movie_app + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:movie_app';
  var devModeSessionKey = '__gwtDevModeSession:movie_app';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':51433';
  var nocacheUrl = serverUrl + '/movie_app/movie_app.nocache.js';
  ...
  $wnd.__gwt_activeModules['movie_app'].canRedirect = true;
  $wnd.__gwt_activeModules['movie_app'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/movie_app?user.agent=' + ua + '&_callback=' + callback;
